...
SECRET_KEY = "a10dd846ef16125290e0f31120eeaa403d14b68622975c4acc100903ae62cab4"
ALGORITHM = 'HS256'
...
async def get_current_user(token: Annotated[AsyncSession, Depends(oauth2_scheme)]):
    try:
